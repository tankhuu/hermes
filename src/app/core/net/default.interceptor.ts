    ...
    switch (ev.status) {
      ...
      default:
        if (ev instanceof HttpErrorResponse) {
          console.warn(
            'Unknown errors, mostly caused by the backend not supporting cross-domain CORS or invalid configuration, please refer to https://ng-alain.com/docs/server Solve cross-domain issues',
            ev,
          );
        }
        break;
